...
def lineplotMD(x_data, y1_data, y2_data, y3_data, y4_data, x_label="", y_label="", title=""):
    _, ax = plt.subplots()
    ax.plot(x_data, y1_data, '--go', lw=2, label=('Теория'))
...
def main():
    data = []
    with open("/Users/da.vasilyev/Desktop/Projects/Model/averageAoi.txt") as f:
        for line in f:
    ...
    lineplotMD(dataX, dataY1, dataY2, dataY3, dataY4, "Входная интенсивность, " + chr(955), "Средний возраст информации", "Среднее значение возраста информации от входной интенсивности\nдля различных законов распределения")
    plt.legend()
