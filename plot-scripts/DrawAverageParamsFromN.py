...
def main():
    ...
    plt.legend()
    lineplotLambda(dataX, dataY11, dataY21, dataY31, "Входная интенсивность, " + chr(955), "Выходная интенсивность, " + chr(955), "Среднее значение выходной интенсивности\nот входной интенсивности")
    plt.legend()
